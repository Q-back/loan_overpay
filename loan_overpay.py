...
def calculate_loan_installment(
    ...
    loan_capital_left = loan_value_gr - (overpay_pln * 100)
    already_payed_gr = 0
    ...
    for interation in range(number_of_installments):
        ...
        loan_capital_left -= initial_installment_value
...
# Use it like this:
calculate_loan_installment(300000, 7.50, 300)
calculate_loan_installment(300000, 7.50, 300, overpay_pln=20000)
